...
export const  StructError   =  {
  ...
  "STRUCT_HAVE_CHAIN" :{ section , info : 'STRUCT_HAVE_CHAIN' , msg : '', code : 1001 } ,
  "PATTERN_STRUCT_ID_IS_WRONG" :{ section , info : 'PATTERN_STRUCT_ID_IS_WRONG' , msg : '', code : 1002 } ,
  ...
  "MICRO_SERVER_STRUCT_IS_DUPLICATED" :{ section , info : 'MICRO_SERVER_STRUCT_IS_DUPLICATED' , msg : '' , code : 1009 }
