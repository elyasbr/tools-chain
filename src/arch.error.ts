const section ='Arch'
export const  ArchError   =  {
  "ARCH_NOT_FOUND" :{ section , info : 'ARCH_NOT_FOUND' , msg : '' , code : 1000 } ,
  "SLUG_FIELD_ARCH_IS_REQUIRED" :{ section , info : 'SLUG_FIELD_ARCH_IS_REQUIRED' , msg : '' , code : 1001 } ,
